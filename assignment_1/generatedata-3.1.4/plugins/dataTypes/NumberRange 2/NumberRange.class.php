...
<div id="real_num" hidden>
	<input type="radio" name="opt_%ROW%" value="as_is" checked>As is
	<input type="radio" name="opt_%ROW%" value="round">Round
	<input type="radio" name="opt_%ROW%" value="ceil">Ceil
	<input type="radio" name="opt_%ROW%" value="floor">Floor
</div>
...
END;
	...
	<script>
		$('#dtExample_%ROW%').change(function() { 			// on options change	
